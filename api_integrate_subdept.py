...
"""
    ...
    root_directory = f"./results_transcripts_subdept/{ticker}"
...
if __name__ == "__main__":
    ...
    data_pl_d_sd = pd.read_csv("./data/Updated_Product_Lines_and_Departments_with_Relevant_Subdepartment__Revised_.csv")
    candidate_labels = list(data_pl_d_sd["relevant_subdepartment"])
